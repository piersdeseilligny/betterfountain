...
export const regex: { [index: string]: RegExp } = {
    title_page: /(title|credit|author[s]?|source|notes|draft date|date|watermark|contact[ info]?|revision|copyright|font)\:.*/i,
    ...
    if (generate_html) {
        ...
        while (current_index < result.title_page.length) {
            ...
            switch (current_token.type) {
                ...
                case 'contact info': titlehtml.push('<p class="contact haseditorline titlepagetoken" id="sourceline_' + current_token.line + '">' + current_token.html + '</p>'); break;
