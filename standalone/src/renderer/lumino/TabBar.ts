...
import {
  ...
  class TabBar<T> extends Widget {
    ...
    constructor(options: TabBar.IOptions<T> = {}) {
      ...
      this._guid = options.guid || this.createUUID();
    ...
    /**
     * Set another tabbar to be synced with this one
     */
    set sync(value: TabBar<Widget>){
      if(this._sync === value){
        return
      }
      else{
    ...
    /**
     * Get the tabbar which should be synced with this one
     */
    get guid(): string{
      return this._guid;
    }
  ...
  namespace TabBar {
    ...
    interface IOptions<T> {
      ...
      /**
       * Another tabbar whose behaviour should be synced with this one
       */
      sync?:TabBar<Widget>;
